 ...
 **Last Updated:** 2026-05-03
 ...
 | Goal | Page |
 |------|------|
 | Patch node or editor UI behavior | [JavaScript Hooks](javascript-hooks.md) |
 | React to server-side execution events | [Server Hooks](server-hooks.md) |
 | Compare the extension surfaces broadly | [Extension Points](extension-points.md) |
