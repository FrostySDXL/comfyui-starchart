...
- **Examples:** API endpoint reference, hook catalogs, datatype definitions,
  `docs/known-limitations/index.md`
...
- **Examples:** `docs/ecosystem/map.md` (generated from
...
- **Examples:** `docs/deep-dives/comfyui-manager.md`,
  `docs/deep-dives/comfyui-impact-pack.md`
