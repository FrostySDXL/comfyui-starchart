# Community Generated Surfaces

**Evidence:** Operational guidance
**Last Updated:** 2026-05-06
**Related:** `references/community/ecosystem_packages.json`, `references/community/community_pages.json`, `docs/ecosystem/map.md`, `docs/reference/community-maintenance-policy.md`
