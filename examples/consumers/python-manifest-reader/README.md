...
```bash
py -3.11 examples/consumers/python-manifest-reader/read_manifest.py https://frostysdxl.github.io/comfyui-starchart server_endpoints.json
py -3.11 examples/consumers/python-manifest-reader/validate_artifact.py https://frostysdxl.github.io/comfyui-starchart server_endpoints.json
```
