...
```bash
node examples/consumers/javascript-docs-and-artifacts/load_docs_index.mjs https://frostysdxl.github.io/comfyui-starchart tooling
node examples/consumers/javascript-docs-and-artifacts/load_manifest.mjs https://frostysdxl.github.io/comfyui-starchart js_hooks.json
```
