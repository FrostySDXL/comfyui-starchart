...
At the pinned `v0.26.0` baseline, prompt execution crosses a few distinct
stages:
...
and `references/snapshots/2026-06-26/comfyui-core-v0.26.0/execution.py`.
...
pinned snapshots: `references/snapshots/2026-06-26/comfyui-core-v0.26.0/server.py`
and `references/snapshots/2026-06-26/comfyui-core-v0.26.0/execution.py`.
...
from pinned snapshots: `references/snapshots/2026-06-26/comfyui-core-v0.26.0/server.py`
and `references/snapshots/2026-06-26/comfyui-core-v0.26.0/execution.py`.
