...
At the pinned `v0.28.0` baseline, prompt execution crosses a few distinct
stages:
...
and `references/snapshots/2026-07-23/comfyui-core-v0.28.0/execution.py`.
...
pinned snapshots: `references/snapshots/2026-07-23/comfyui-core-v0.28.0/server.py`
and `references/snapshots/2026-07-23/comfyui-core-v0.28.0/execution.py`.
...
from pinned snapshots: `references/snapshots/2026-07-23/comfyui-core-v0.28.0/server.py`
and `references/snapshots/2026-07-23/comfyui-core-v0.28.0/execution.py`.
