...
**Primary Sources:** https://docs.comfy.org/custom-nodes/walkthrough, https://docs.comfy.org/custom-nodes/backend/server_overview, https://docs.comfy.org/custom-nodes/backend/more_on_inputs, `references/snapshots/2026-05-21/comfyui-core-v0.22.0/server.py`, `references/snapshots/2026-05-21/comfyui-core-v0.22.0/execution.py`, `references/snapshots/2026-05-21/comfyui-core-v0.22.0/comfy_api/latest/_io.py`
